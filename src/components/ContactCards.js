    ...
    return (
        <div >
            <article className="contact-cards">
                <Paper className="contact-card" elevation={24}>
                    ...
                    <Typography variant={"subtitle2"} fontWeight={"normal"}>La Pampa 2802, CABA</Typography>
                </Paper>
                <Paper className="contact-card" elevation={24}>
                    ...
                    <Typography variant={"subtitle2"} fontWeight={"normal"} style={{textDecoration:"none", textTransform:"none"}}><a href="tel:5491126486047" style={{textDecoration:"none", textTransform:"none", color:'#000'}}>(+5491126486047)</a></Typography>
                </Paper>
                <Paper className="contact-card" elevation={24}>
                    ...
                    <Typography variant={"subtitle2"} fontWeight={"normal"} style={{textDecoration:"none", textTransform:"none"}}><a href="mailto:curellich@gmail.com" style={{textDecoration:"none", textTransform:"none", color:'#000'}}>curellich@gmail.com</a></Typography>
                </Paper>
